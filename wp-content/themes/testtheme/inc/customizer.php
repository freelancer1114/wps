 ...
 * @return void
 */
function testtheme_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function testtheme_customize_partial_blogdescription() {
...
function testtheme_customize_preview_js() {
	wp_enqueue_script( 'testtheme-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
